...
if ($_POST['aksi'] == 'ubah') {
    ...
    <form id="form" action="editdata.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="NOHP" name="nohp" placeholder="Tulis no HP" value="<?= $nohp; ?>">
        </div>
        <div class="mb-3">
